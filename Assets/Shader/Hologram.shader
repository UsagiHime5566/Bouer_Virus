    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            vec3 getColor(vec3 p, vec3 ray)
            {
                ...
                return max(vec3(0.2, 0.5, 0.8) * 7.0 * pow(pos.y, 4.0) * smoothstep(0.0, -1.0, length(pos.xz) - 5.0), vec3(0.0,0,0));
            }
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                vec3 ray = mul(c , normalize(vec3(p, 2.5)));
